// Shared-password gate for /admin/*. Replaces the old user-allowlist
// (lib/auth/admins.js) with a single ADMIN_PASSWORD env var. Anyone who
// types the right password — regardless of whether they have a regular
// user account — gets a session cookie and admin access for 24 hours.
//
// Tradeoff vs. the email allowlist: no audit identity (we can't tell
// which admin did what). Acceptable for MVP because the team is 1-2
// people. Move to email-based admin auth + 2FA before that grows.
//
// Cookie:
//   name : gc_admin
