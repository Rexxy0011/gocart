...
//
// The middleware password gate (lib/auth/admin-pass.js) is the access
// check. Admin server routes use this client to read private storage /
// write any table without RLS friction.
