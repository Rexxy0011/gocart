...
export default async function StoreInquiries() {
    ...
    const { conversations, lastMessages } = await fetchConversationsForUser(
        supabase, user.id, 'selling-products'
    )
        ...
        <div className='text-slate-700 mb-28 max-w-4xl'>
            <div className='flex items-center gap-3 mb-6'>
                ...
                <div>
                    ...
                    <p className='text-sm text-slate-500'>Buyer messages on your product listings. Reply directly - Kakimart never takes a cut on offline sales.</p>
                </div>
            </div>
            ...
            <ConversationList
                ...
                emptyHint='When a buyer messages you about one of your listings, the conversation lands here.'
            />
        </div>
    )
}
